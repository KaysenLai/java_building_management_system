...
public abstract class TimedSensor implements TimedItem, Sensor, Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        TimedSensor castObj = (TimedSensor) obj;

        return this.getUpdateFrequency() == castObj.getUpdateFrequency() &&
                Arrays.equals(this.sensorReadings, castObj.sensorReadings);
    }

    /**
     * Returns the hash code of this timed sensor.
     * Two timed sensors that are equal according to equals(Object) should
    ...
    public int hashCode() {
        final int prime = 7;
        int result = 1;
        int readingsHashCode = Arrays.hashCode(sensorReadings);

        result = prime * result + updateFrequency;
        result = prime * result + readingsHashCode;
        return result;
    }
