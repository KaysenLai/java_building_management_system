...
public class OccupancySensor extends TimedSensor
     ...
     * given by the current sensor reading divided by the maximum capacity.
     *
    ...
    public int getComfortLevel() {
        return 100 - this.getHazardLevel();
    }
    ...
    public boolean equals(Object obj) {
        OccupancySensor castObj = (OccupancySensor) obj;
        return super.equals(obj) && this.getCapacity() == castObj.getCapacity();
    }
    ...
    @Override
    public int hashCode() {
        final int typePrime = 11;
        return super.hashCode() * typePrime + capacity;
    }
