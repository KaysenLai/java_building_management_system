...
public class NoiseSensor extends TimedSensor
    ...
    public int getComfortLevel() {
        ...
        double result = (1 - RelativeLoudness) * (double) 100;
        return result < 0 ? 0 : (int) Math.floor(result);
    }

    /**
     * Returns true if and only if this Noise sensor is equal to the
     * other given sensor.
     *
     * For two Noise sensors to be equal, they must have the same:
     * ·update frequency
    ...
    /**
     * Returns the hash code of this Noise sensor.
     * Two Noise sensors that are equal according to equals(Object) should
     ...
     *
     * where 'sensorReadingX' is the Xth sensor reading in this sensor's list of readings, from 1 to N where N is the number of readings, and 'frequency' is this sensor's update frequency (in minutes).
